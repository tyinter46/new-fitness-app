...
router.delete("/lessons/:id", async (req, res) => {
 ...
 const deleteStudent = await pool.query("DELETE FROM lessons WHERE lessons_id = $1 RETURNING *", [id])
...
router.put("/lessons/:id", async (req, res) => {
  ...
  const updateInstructor = await pool.query("UPDATE lessons SET  name = $1,   price = $2, description = $3, unit = $4, expiry_date = $5 WHERE lessons_id = $7 RETURNING *", 
  [ 
    lesson_name,
    price,
    description,
